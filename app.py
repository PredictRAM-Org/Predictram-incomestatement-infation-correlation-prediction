...
if uploaded_file is not None:
    try:
        ...
        st.write("Merged Data Columns:", merged_data.columns)

        # Check if the specified columns exist in the DataFrame
        required_columns = ['Total Revenue/Income', 'Total Operating Expense', 'Income/Profit Before Tax', 'Net Income', 'Inflation']
        if all(column in merged_data.columns for column in required_columns):
            # Calculate correlations
            correlation_data = merged_data[required_columns]
            ...
            st.write("Error: One or more required columns are missing.")
